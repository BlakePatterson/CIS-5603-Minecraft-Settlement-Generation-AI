...
\begin{figure}[H]%
    \centering
    \subfloat[\centering Genetic Space Tree \cite{hartsook2011toward}]{{\includegraphics[width=0.4\textwidth]{gen1} }}%
    \qquad
    \subfloat[\centering Environment Transition Graph \cite{hartsook2011toward}]{{\includegraphics[width=0.4\textwidth]{gen2} }}%
